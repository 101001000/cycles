...
class PortableRTDevice : public GPUDevice {
 ...
 public:
  ...
  PortableRTDeviceKernels kernels;
  ...
  PortableRTDevice(const DeviceInfo &info, Stats &stats, Profiler &profiler, bool headless);

  ~PortableRTDevice() override;
